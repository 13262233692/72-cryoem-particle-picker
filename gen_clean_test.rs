...
fn main() {
    ...
    write_mrc("ref_clean.mrc", nx, ny, &ref_img);
    println!("Created ref_clean.mrc: particle at ({}, {})", ref_cx, ref_cy);
    ...
    write_mrc("tgt_clean.mrc", nx, ny, &tgt_img);
    println!("Created tgt_clean.mrc: particle at ({}, {})", tgt_cx, tgt_cy);
